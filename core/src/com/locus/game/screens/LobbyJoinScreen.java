...
class LobbyJoinScreen implements Screen, InputProcessor, GestureDetector.GestureListener {
    ...
    LobbyJoinScreen(ProjectLocus projectLocus, SelectModeScreen selectModeScreen) {
